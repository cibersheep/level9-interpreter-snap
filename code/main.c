...
void do_about ()
{
	...
	"copyright",
	"Copyright (c) 1996-2017 Glen Summers and contributors.\n"
	"Contributions from David Kinder, Alan Staniforth, Simon Baldwin,\n"
	"Dieter Baron, Andreas Scherrer and Joan CiberSheep.",

	"website",
	"https://github.com/DavidKinder/Level9/",

	"website-label",
	"Project Github",
	
	"comments",
	"GTK+ 3.18 interface v" LEVEL9_VERSION_GUI
